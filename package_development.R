# heatwave3_package_development.R
...
use_r(name = "detect3")
use_r(name = "detect3clim")
use_r(name = "detect3event")
...
use_package(package = "terra")
use_package(package = "heatwaveR")
...
use_test("detect3")
use_test("detect3clim")
use_test("detect3event")
...
use_code_of_conduct(contact = "robwschlegel@gmail.com")
