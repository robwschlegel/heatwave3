...
The compute functions always write NetCDF. To read a product into R, or convert
it to CSV, RDS, or Parquet, use `hw3_export()`, which auto-detects the product
type and is backed by the C++ reader:
